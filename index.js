...
function generateQuickTest() {
  manager = new Manager("jared doe", "M001", "jared.doe@gmail.com", "1");
  engineers.push(new Engineer("sam doe", "2", "sam.doe@company.com", "samdoe"));
  interns.push(new Intern("john doe", "5", "john.doe@gmail.com", "UNCC"));
  createHTML();
}
